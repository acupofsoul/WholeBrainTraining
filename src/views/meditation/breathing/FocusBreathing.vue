<template>
  <div class="focus-breathing-container">
    <!-- 面包屑导航 -->
    <BreadcrumbDropdown
      :main-title="'冥想训练'"
    ...
    <div class="page-header">
      ...
      <p class="page-description">
        提升专注力的呼吸练习。通过6-2-6的较长呼吸周期，帮助孩子培养持续专注的能力。
      </p>
    </div>
      ...
      <div class="setup-card">
        ...
        <div class="setup-info">
          <div class="info-item">
            ...
            <span class="info-value">6-2-6 (吸气-保持-呼气)</span>
          </div>
          <div class="info-item">
          ...
          <div class="info-item">
            ...
            <span class="info-value">7-12岁</span>
          </div>
        </div>
        <div class="setup-tips">
          <h4>💡 练习提示</h4>
          <ul>
            <li>较长的呼吸周期有助于提升专注力</li>
            <li>数数可以帮助保持专注</li>
            <li>感受空气进入和离开身体的感觉</li>
            <li>练习时保持脊背挺直</li>
          </ul>
        </div>
    ...
    <div v-if="isTraining" class="training-active">
      <div class="training-header">
        ...
        <div class="training-progress">
          ...
          <span class="total-time">{{ formatTime(600) }}</span>
        </div>
      </div>
      ...
      <div class="completion-card">
        ...
        <div class="completion-stats">
          <div class="stat-item">
            ...
            <span class="stat-value">10分钟</span>
          </div>
          <div class="stat-item">
...
const instructionText = computed(() => {
  switch (breathingPhase.value) {
    case 'inhale': return '深深吸气，专注于呼吸的感觉';
    case 'hold': return '保持呼吸，集中注意力';
    case 'exhale': return '缓缓呼气，保持专注';
    default: return '';
  }
});
...
@keyframes breathe {
  ...
  43% { transform: scale(1.3); opacity: 0.9; }
  57% { transform: scale(1.3); opacity: 0.9; }
  86% { transform: scale(0.7); opacity: 1; }
}
...
.guide-circle.inhale {
  background: radial-gradient(circle, rgba(255, 152, 0, 0.4), rgba(255, 152, 0, 0.1));
  transform: scale(1.3);
}
...
.guide-circle.exhale {
  background: radial-gradient(circle, rgba(230, 81, 0, 0.4), rgba(230, 81, 0, 0.1));
  transform: scale(0.7);
}
