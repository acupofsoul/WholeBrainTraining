  ...
  <div class="space-journey-container">
    ...
    <div class="page-header">
      ...
      <p class="page-description">
        穿上宇航服，登上你的专属飞船，准备开始一场激动人心的太空之旅。
      </p>
    </div>
      ...
      <div class="setup-card">
        ...
        <div class="setup-preview">
          ...
          <div class="preview-text">
            <p>穿上宇航服，登上你的专属飞船，准备开始一场激动人心的太空之旅...</p>
          </div>
        </div>
...
.step-animation.alien-wave {
  background: radial-gradient(circle, rgba(0,255,127,0.4) 0%, transparent 70%);
  animation: alienWave 2s ease-in-out infinite;
}

.step-animation.planet-explore {
  background: radial-gradient(circle, rgba(138,43,226,0.3) 0%, transparent 70%);
  animation: planetExplore 3s ease-in-out infinite;
}

.step-animation.return {
  background: radial-gradient(circle, rgba(30,144,255,0.4) 0%, transparent 70%);
  animation: returnHome 2.5s ease-in-out infinite;
}

@keyframes launch {
  0%, 100% { transform: translate(-50%, -50%) scale(1); }
  50% { transform: translate(-50%, -50%) scale(1.3) translateY(-10px); }
}
