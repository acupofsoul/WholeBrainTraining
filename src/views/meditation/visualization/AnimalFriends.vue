<template>
  <div class="animal-friends-container">
    <!-- 页面头部 -->
    <div class="page-header">
      <div class="header-background">
        <div class="animal-elements">
      ...
      <p class="page-description">
        走进神奇的森林，和可爱的动物朋友们一起玩耍，体验大自然的美好。
      </p>
    </div>
      ...
      <div class="setup-card">
        ...
        <div class="setup-preview">
          ...
          <div class="preview-text">
            <p>走进神奇的森林，和可爱的动物朋友们一起玩耍，体验大自然的美好...</p>
          </div>
        </div>
...
const trainingSteps = ref([
  {
    ...
    title: '走进森林',
    icon: '🌳',
    instruction: '踏进绿色的森林，感受清新的空气和温暖的阳光',
    duration: 60,
    animation: 'forest-walk'
  },
  {
    id: 2,
    title: '小兔子',
    icon: '🐰',
    instruction: '遇到一只可爱的小兔子，它蹦蹦跳跳地向你打招呼',
    duration: 90,
  ...
  },
  {
    ...
    title: '熊宝宝',
    icon: '🐻',
    instruction: '一只友善的小熊走过来，邀请你和它一起玩耍',
    duration: 120,
    animation: 'bear-play'
  },
  {
    ...
    title: '蝴蝶舞蹈',
    icon: '🦋',
    instruction: '美丽的蝴蝶在花丛中翩翩起舞，你和动物朋友们一起欣赏',
    duration: 90,
    animation: 'butterfly-dance'
  },
  {
    id: 5,
    title: '告别朋友',
    icon: '👋',
    instruction: '和所有的动物朋友们挥手告别，约定下次再来玩',
    duration: 60,
    animation: 'goodbye-wave'
  }
])
...
.step-animation.forest-walk {
  background: radial-gradient(circle, rgba(34,139,34,0.3) 0%, transparent 70%);
  animation: forestWalk 2s ease-in-out infinite;
}

.step-animation.rabbit-hop {
  background: radial-gradient(circle, rgba(255,182,193,0.4) 0%, transparent 70%);
  animation: rabbitHop 1.5s ease-in-out infinite;
}

.step-animation.bear-play {
  background: radial-gradient(circle, rgba(139,69,19,0.4) 0%, transparent 70%);
  animation: bearPlay 2.5s ease-in-out infinite;
}

.step-animation.butterfly-dance {
  background: radial-gradient(circle, rgba(255,20,147,0.3) 0%, transparent 70%);
  animation: butterflyDance 2s ease-in-out infinite;
}

.step-animation.goodbye-wave {
  background: radial-gradient(circle, rgba(255,215,0,0.4) 0%, transparent 70%);
  animation: goodbyeWave 1.8s ease-in-out infinite;
}
